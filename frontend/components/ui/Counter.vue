<template>
  <div
    class="inline-flex items-center gap-1 rounded-lg border border-gray-200 bg-white shadow-sm px-2 py-1"
    role="group"
...
function onInput(e: Event) {
  ...
  (e.target as HTMLInputElement).value = (e.target as HTMLInputElement).value.replace(/[^\d]/g, '').slice(0, 2)
...
button:hover { box-shadow: 0 6px 10px rgba(0,0,0,0.06); }
</style>