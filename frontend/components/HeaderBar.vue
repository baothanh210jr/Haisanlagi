            ...
            <div v-else class="space-y-8 px-6 py-6">
              <section>
                <div class="flex items-center justify-between">
                  <p class="text-sm font-semibold text-gray-700">Tìm kiếm gần đây</p>
                  <button
                ...
                <div v-if="recentSearches.length" class="mt-3 flex flex-wrap gap-2">
                  <button
              ...
              <section class="space-y-3 rounded-2xl bg-gray-50 p-4">
                <p class="text-sm font-semibold text-gray-700">Gợi ý phổ biến</p>
                ...
                <div class="rounded-2xl bg-white p-4 shadow-sm">
                  <p class="text-sm font-semibold text-gray-800">Mẹo</p>
